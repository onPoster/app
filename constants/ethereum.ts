...
export const DEFAULT_IPFS_API = process.env.NEXT_PUBLIC_GITPOD_IPFS_API_URL || (process.env.NODE_ENV != 'production' ? 'http://localhost:5001' : 'https://ipfs.infura.io:5001')
export const DEFAULT_IPFS_GATEWAY = process.env.NEXT_PUBLIC_GITPOD_IPFS_GATEWAY_URL || (process.env.NODE_ENV != 'production' ? 'http://localhost:8080' : 'https://ipfs.infura.io')
